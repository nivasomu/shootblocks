	...
	document.body.innerHTML += '<canvas id="canvas" width="1200" height="600"></canvas>';

	var fps = 30;
	var canvas = document.getElementById('canvas');
	var ctx = canvas.getContext("2d");			
	//var bgColor = "rgb(40,40,40)"
	var bgColor = "rgb(0, 51, 102)"
	var ready;
	var enemyScore;
	...
	function initializeTimers(){
		difficultyTimer = setInterval(increaseLevel,2000);
	...
	function drawScore(){
		...
		ctx.fillText("Your Score: " + score,10,24);
		...
		ctx.font = "16px sans-serif";
		ctx.fillText("Level: " + level,canvas.width/2 - 50,24);
	}
